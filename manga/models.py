...
from manga_back.constants import CATEGORY_CHOICES, COUNTRY_CHOICES, MANGA_GENRES, MANGA_TAGS
...
class Manga(models.Model):
    ...
    avatar = models.ImageField(upload_to="static/images/avatars/", default="default/none_avatar.png/", blank=True)
