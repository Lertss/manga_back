...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('title', models.CharField(choices=[('Manga', 'Manga'), ('Manhua', 'Manhua'), ('Manhwa', 'Manhwa'), ('Comics', 'Comics'), ('Web', 'Web'), ('Other', 'Other')], max_length=50, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Chapter',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('genr', models.CharField(choices=[('Action', 'Action'), ('Adventure', 'Adventure'), ('Apocalypse', 'Apocalypse'), ('Comedy', 'Comedy'), ('Cyberpunk', 'Cyberpunk'), ('Detective', 'Detective'), ('Drama', 'Drama'), ('Fairy Tale', 'Fairy Tale'), ('Fantasy', 'Fantasy'), ('Gothic', 'Gothic'), ('Harem', 'Harem'), ('Hentai', 'Hentai'), ('History', 'History'), ('Horror', 'Horror'), ('Josei', 'Josei'), ('Kodomo', 'Kodomo'), ('Lolicon', 'Lolicon'), ('Maho Kanojo', 'Maho Kanojo'), ('Maho Shoujo', 'Maho Shoujo'), ('Maho Shounen', 'Maho Shounen'), ('Mecha', 'Mecha'), ('Post-apocalypse', 'Post-apocalypse'), ('Romance', 'Romance'), ('School Life', 'School Life'), ('Sci-fi', 'Sci-fi'), ('Seinen', 'Seinen'), ('Sentai', 'Sentai'), ('Shotacon', 'Shotacon'), ('Shoujo', 'Shoujo'), ('Shoujo Ai', 'Shoujo Ai'), ('Shounen', 'Shounen'), ('Shounen Ai', 'Shounen Ai'), ('Slice of Life', 'Slice of Life'), ('Steampunk', 'Steampunk'), ('Western', 'Western'), ('Yaoi', 'Yaoi'), ('Yuri', 'Yuri')], max_length=50, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Tags',
